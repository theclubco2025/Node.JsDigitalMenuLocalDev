          ...
          {filteredCategories.length === 0 && (
            <div className="rounded-xl p-4" style={{ background: 'var(--card)', border: '1px solid var(--muted)' }}>
              ...
              <div className="mt-1 text-xs" style={{ color: 'var(--ink)', opacity: 0.78 }}>
                This menu may not list enough ingredient details to filter reliably. This menu may not list enough ingredient details to filter reliably. Try removing the &quot;No gluten/dairy/nuts listed&quot; filters,
                or use <span className="font-semibold">Ask AI</span> / ask staff for allergy needs.
              </div>
              <div className="mt-3 flex justify-center">
                <button
                  onClick={() => { setSearchQuery(''); setActiveSection('All'); setSelectedCategories([]); setSelectedDietaryFilters([]) }}
