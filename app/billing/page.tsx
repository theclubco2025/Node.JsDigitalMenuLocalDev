...
export default function BillingPage() {
  ...
  const normalizedTenant = useMemo(() => tenant.toLowerCase(), [tenant])
  ...
  useEffect(() => {
    if (!['buttercuppantry', 'southforkgrille', 'south-fork-grille', 'independent'].includes(normalizedTenant)) return
